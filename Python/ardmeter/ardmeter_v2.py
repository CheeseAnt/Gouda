...
class MyApp(wx.App):
    def OnInit(self):
        ...
        #self.app = wx.App()
        self.frame = wx.Frame(None, -1, 'MainFrame2') #self.res.LoadFrame(None, "MainFrame")
        ...
        self.plotpanel = PlotPanel(self.frame)
        ...
        self.closeBtn = wx.Button(self.frame, label='Close')
